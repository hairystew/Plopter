...
void Plopter::read_barometer(void)
{
    barometer.update();
...
void Plopter::init_rangefinder(void)
{
...
void Plopter::read_rangefinder(void)
{
#if RANGEFINDER_ENABLED == ENABLED
    rangefinder.update();
...
bool Plopter::rangefinder_alt_ok() const
{
    return (rangefinder_state.enabled && rangefinder_state.alt_healthy);
}

// return true if rangefinder_alt can be used
bool Plopter::rangefinder_up_ok() const
{
 ...
 */
bool Plopter::get_rangefinder_height_interpolated_cm(int32_t& ret)
{
