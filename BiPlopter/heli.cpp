...
// Traditional heliplopter variables and functions
...
void Plopter::check_dynamic_flight(void)
{
...
void Plopter::update_heli_control_dynamics(void)
{
    ...
    // set hover roll trim scalar, will ramp from 0 to 1 over 1 second after we think heliplopter has taken off
    attitude_control->set_hover_roll_trim_scalar((float) hover_roll_trim_scalar_slew/(float) scheduler.get_loop_rate_hz());
}

bool Plopter::should_use_landing_swash() const
{
...
void Plopter::heli_update_landing_swash()
{
...
float Plopter::get_pilot_desired_rotor_speed() const
{
...
void Plopter::heli_update_rotor_speed_targets()
{
...
void Plopter::heli_update_autorotation()
{
...
void Plopter::heli_set_autorotation(bool autorotation)
{
...
void Plopter::update_collective_low_flag(int16_t throttle_control)
{
