...
#include <AC_WPNav/AC_WPNav.h>              // ArduPlopter waypoint navigation library
#include <AC_WPNav/AC_Loiter.h>             // ArduPlopter Loiter Mode Library
...
#include <AC_AutoTune/AC_AutoTune_Multi.h>  // ArduPlopter autotune library. support for autotune of multirotors.
#include <AC_AutoTune/AC_AutoTune_Heli.h>   // ArduPlopter autotune library. support for autotune of heliplopters.
...
# include USERHOOK_VARIABLES
    ...
    // Only used for Heliplopter for now
#if FRAME_CONFIG == HELI_FRAME
    ...
    // and 1 high glitch.  This is because any "off" glitches can be highly problematic for a heliplopter running an ESC
