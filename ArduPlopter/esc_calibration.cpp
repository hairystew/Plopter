...
void Plopter::esc_calibration_startup_check()
{
...
void Plopter::esc_calibration_passthrough()
{
#if FRAME_CONFIG != HELI_FRAME
    // send message to GCS
...
void Plopter::esc_calibration_auto()
{
#if FRAME_CONFIG != HELI_FRAME
    // send message to GCS
...
void Plopter::esc_calibration_notify()
{
    AP_Notify::flags.esc_calibration = true;
...
void Plopter::esc_calibration_setup()
{
    // clear esc flag for next time
