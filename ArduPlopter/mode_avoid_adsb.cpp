 ...
 * for GCS and Companion Computers vs the AP_Avoidance_Plopter class for adsb avoidance) and inputs from
...
{
    // check flight mode
    if (plopter.flightmode->mode_number() != Mode::Number::AVOID_ADSB) {
        return false;
    }
