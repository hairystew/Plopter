...
public:
    ...
    Tiltrotor(QuadPlopter& _quadplopter, AP_MotorsMulticopter*& _motors);
...
// Transition for separate left thrust quadplopters
class Tiltrotor_Transition : public SLT_Transition
{
friend class Tiltrotor;
public:

    Tiltrotor_Transition(QuadPlopter& _quadplopter, AP_MotorsMulticopter*& _motors, Tiltrotor& _tiltrotor):SLT_Transition(_quadplopter, _motors), tiltrotor(_tiltrotor) {};
