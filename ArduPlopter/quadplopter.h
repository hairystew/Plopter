...
/*
  QuadPlopter specific functionality
 */
class QuadPlopter
{
public:
    ...
    QuadPlopter(AP_AHRS &_ahrs);

    static QuadPlopter *get_singleton() {
        return _singleton;
    }
...
private:
    ...
    // check for quadplopter assistance needed
    ...
    */
    ...
    // oneshot with duration ARMING_DELAY_MS used by quadplopter to delay spoolup after arming:
