 ...
 */
bool Plopter::allow_reverse_thrust(void) const
{
 ...
 */
bool Plopter::have_reverse_thrust(void) const
{
 ...
 */
float Plopter::get_throttle_input(bool no_deadzone) const
{
    float ret;
    if (no_deadzone) {
 ...
 */
float Plopter::get_adjusted_throttle_input(bool no_deadzone) const
{
    if ((plopter.channel_throttle->get_type() != RC_Channel::ControlType::RANGE) ||
