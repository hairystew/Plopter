...
void AP_AdvancedFailsafe_Plopter::setup_IO_failsafe(void)
{
    ...
    uint16_t mask = plopter.motors->get_motor_mask();
    hal.rcout->set_failsafe_pwm(mask, plopter.motors->get_pwm_output_min());
#endif
}
