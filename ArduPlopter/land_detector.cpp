...
void Plopter::update_land_and_crash_detectors()
{
...
// called at MAIN_LOOP_RATE
void Plopter::update_land_detector()
{
...
void Plopter::set_land_complete(bool b)
{
...
void Plopter::set_land_complete_maybe(bool b)
{
    // if no change, exit immediately
...
void Plopter::update_throttle_mix()
{
#if FRAME_CONFIG != HELI_FRAME
