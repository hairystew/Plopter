...
class RC_Channel_Plopter : public RC_Channel
{
...
class RC_Channels_Plopter : public RC_Channels
{
public:

    RC_Channel_Plopter obj_channels[NUM_RC_CHANNELS];
    RC_Channel_Plopter *channel(const uint8_t chan) override {
...
protected:
    ...
    // note that these callbacks are not presently used on Plopter:
