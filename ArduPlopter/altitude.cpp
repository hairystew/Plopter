 ...
 */
void Plopter::adjust_altitude_target()
{
    ...
    if ((control_mode == &mode_loiter) && plopter.stick_mixing_enabled() && (plopter.g2.flight_options & FlightOptions::ENABLE_LOITER_ALT_CONTROL)) {
       return;
    }
 ...
 */
void Plopter::setup_glide_slope(void)
{
 ...
 */
int32_t Plopter::get_RTL_altitude_cm() const
{
...
/*
  ...
  or home otherwise)
 */
float Plopter::relative_ground_altitude(bool use_rangefinder_if_available)
{
   ...
   if (use_rangefinder_if_available && quadplopter.in_vtol_land_final() &&
       rangefinder.status_orient(ROTATION_PITCH_270) == RangeFinder::Status::OutOfRangeLow) {
       // a special case for quadplopter landing when rangefinder goes
...
#if HAL_QUADPLANE_ENABLED
    if (quadplopter.in_vtol_land_descent() &&
        !(quadplopter.options & QuadPlopter::OPTION_MISSION_LAND_FW_APPROACH)) {
...
/*
  ...
  CRUISE mode.
 */
void Plopter::set_target_altitude_current(void)
{
 ...
 */
void Plopter::set_target_altitude_current_adjusted(void)
{
 ...
 */
void Plopter::set_target_altitude_location(const Location &loc)
{
 ...
 */
int32_t Plopter::relative_target_altitude_cm(void)
{
#if AP_TERRAIN_AVAILABLE
 ...
 */
void Plopter::change_target_altitude(int32_t change_cm)
{
 ...
 */
void Plopter::set_target_altitude_proportion(const Location &loc, float proportion)
{
 ...
 */
void Plopter::constrain_target_altitude_location(const Location &loc1, const Location &loc2)
{
 ...
 */
int32_t Plopter::calc_altitude_error_cm(void)
{
#if AP_TERRAIN_AVAILABLE
 ...
 */
void Plopter::check_fbwb_minimum_altitude(void)
{
 ...
 */
void Plopter::reset_offset_altitude(void)
{
...
/*
  ...
  positive.
 */
void Plopter::set_offset_altitude_location(const Location &start_loc, const Location &destination_loc)
{
...
/*
  ...
  terrain
 */
bool Plopter::above_location_current(const Location &loc)
{
#if AP_TERRAIN_AVAILABLE
    float terrain_alt;
    if (loc.terrain_alt && 
 ...
 */
void Plopter::setup_terrain_target_alt(Location &loc) const
{
#if AP_TERRAIN_AVAILABLE
 ...
 */
int32_t Plopter::adjusted_altitude_cm(void)
{
 ...
 */
int32_t Plopter::adjusted_relative_altitude_cm(void)
{
 ...
 */
float Plopter::mission_alt_offset(void)
{
 ...
 */
float Plopter::height_above_target(void)
{
 ...
 */
float Plopter::lookahead_adjustment(void)
{
#if AP_TERRAIN_AVAILABLE
    int32_t bearing_cd;
    int16_t distance;
 ...
 */
float Plopter::rangefinder_correction(void)
{
 ...
 */
void Plopter::rangefinder_terrain_correction(float &height)
{
#if AP_TERRAIN_AVAILABLE
 ...
 */
void Plopter::rangefinder_height_update(void)
{
    ...
    if ((rangefinder.status_orient(ROTATION_PITCH_270) == RangeFinder::Status::Good)) {
        ...
        if (rangefinder_state.in_range_count < 10) {
            ...
            if (control_mode == &mode_qland ||
                ...
                (control_mode == &mode_auto && quadplopter.is_vtol_land(plopter.mission.get_current_nav_cmd().id))) {
                flightstage_good_for_rangefinder_landing = true;
            }
#endif
 ...
 */
#if AP_TERRAIN_AVAILABLE
const Plopter::TerrainLookupTable Plopter::Terrain_lookup[] = {
...
bool Plopter::terrain_enabled_in_current_mode() const
{
    return terrain_enabled_in_mode(control_mode->mode_number());
}

bool Plopter::terrain_enabled_in_mode(Mode::Number num) const
{
    // Global enable
