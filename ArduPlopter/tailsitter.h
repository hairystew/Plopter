...
public:
    ...
    Tailsitter(QuadPlopter& _quadplopter, AP_MotorsMulticopter*& _motors);
    ...
    // bit 0 enables plopter mode and bit 1 enables body-frame roll mode
    enum input {
...
public:
    ...
    Tailsitter_Transition(QuadPlopter& _quadplopter, AP_MotorsMulticopter*& _motors, Tailsitter& _tailsitter):Transition(_quadplopter, _motors), tailsitter(_tailsitter) {};
