...
/// @file    AC_AttitudeControl_Plopter.h
/// @brief   ArduPlopter attitude control library
...
class AC_AttitudeControl_Plopter : public AC_AttitudeControl {
public:
	AC_AttitudeControl_Plopter(AP_AHRS_View &ahrs, const AP_Vehicle::MultiCopter &aparm, AP_MotorsMulticopter& motors, float dt);

	// empty destructor to suppress compiler warning
	virtual ~AC_AttitudeControl_Plopter() {}
